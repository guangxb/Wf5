...
namespace Sys.Workflow.Business
{
    internal abstract class NextActivityScheduleBase
    {
            ...
            out NextActivityMatchedType resultType)
        {
            ...
            if (forwardTransition.ToActivity.NodeType == NodeTypeEnum.TaskNode
                || forwardTransition.ToActivity.NodeType == NodeTypeEnum.EndNode)
            {
            ...
            else if (forwardTransition.ToActivity.NodeType == NodeTypeEnum.GatewayNode)
            {
            ...
            else
            {
                ...
                throw new XmlDefinitionException(string.Format("未知的节点类型：{0}", forwardTransition.ToActivity.NodeType.ToString()));
            }
            return child;
        }
