...
namespace Sys.WorkflowApi.Utility
{
    /// <summary>
    /// 响应结果类
    /// </summary>
        ...
        where T : class
    {
        ...
        /// <param name="Message">消息内容</param>
        /// <returns></returns>
        public static ResponseResult<T> Default(T t, string message = null)
        {
        ...
        /// <param name="Message">消息内容</param>
        /// <returns></returns>
        public static ResponseResult<T> Error(T t, string message = null)
        {
            var result = new ResponseResult<T>();
            result.Entity = t;
            result.Status = -1;
